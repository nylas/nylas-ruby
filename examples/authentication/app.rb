...
NYLAS_API = "https://api.nylas.com".freeze
GOOGLE_OAUTH_TOKEN_VALIDATION_URL = "https://www.googleapis.com/oauth2/v2/tokeninfo".freeze
GOOGLE_OAUTH_AUTH_URL = "https://accounts.google.com/o/oauth2/v2/auth".freeze
GOOGLE_OAUTH_ACCESS_TOKEN_URL = "https://www.googleapis.com/oauth2/v4/token".freeze
...
get "/google" do
  ...
  redirect to("/google/oauth2callback") unless session[:google_access_token]

  # The user has authorized with google at this point but we will need to
  # connect the account to Nylas
  unless session[:nylas_access_token]
...
get "/" do
  ...
  body += recent_emails.join("<br>").to_s
  body
end
