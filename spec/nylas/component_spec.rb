...
describe Nylas::Component do
  # Deserializes a component's JSON attributes into Ruby objects.
  ...
  # Saves components as JSON payloads.
  describe "saving" do
    # Sends a POST call for a component with no ID set.
    ...
    # Sends a PUT call for a component with an ID set.
