...
describe Nylas::Domains do
  ...
  describe "#list" do
    ...
    it "calls the get_list method with the correct parameters and query params" do
      ...
      domains_response = domains.list(query_params: query_params)
  ...
  describe "#find" do
    it "calls the get method with the correct parameters" do
      ...
      domain_response = domains.find(domain_id: domain_id)
  ...
  describe "#create" do
    it "calls the post method with the correct parameters" do
      ...
      domain_response = domains.create(request_body: request_body)
  ...
  describe "#destroy" do
    it "calls the delete method with the correct parameters" do
      ...
      domain_response = domains.destroy(domain_id: domain_id)
