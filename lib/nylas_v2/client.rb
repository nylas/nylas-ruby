...
module NylasV2
  ...
  class Client
    ...
    #
    # @return [NylasV2::Applications] Application resources for your Nylas application.
    def applications
    ...
    #
    # @return [NylasV2::Attachments] Attachment resources for your Nylas application.
    def attachments
    ...
    #
    # @return [NylasV2::Auth] Auth resources for your Nylas application.
    def auth
      Auth.new(self)
    end
    ...
    #
    # @return [NylasV2::Calendars] Calendar resources for your Nylas application.
    def calendars
      Calendars.new(self)
    end
    ...
    #
    # @return [NylasV2::Connectors] Connector resources for your Nylas application.
    def connectors
      Connectors.new(self)
    end
    ...
    #
    # @return [NylasV2::Contacts] Contact resources for your Nylas application.
    def contacts
      Contacts.new(self)
    end
    ...
    #
    # @return [NylasV2::Drafts] Draft resources for your Nylas application.
    def drafts
      Drafts.new(self)
    end
    ...
    #
    # @return [NylasV2::Events] Event resources for your Nylas application
    def events
      Events.new(self)
    end
    ...
    #
    # @return [NylasV2::Folder] Folder resources for your Nylas application
    def folders
      Folders.new(self)
    end
    ...
    #
    # @return [NylasV2::Grants] Grant resources for your Nylas application
    def grants
      Grants.new(self)
    end
    ...
    #
    # @return [NylasV2::Messages] Message resources for your Nylas application
    def messages
      Messages.new(self)
    end
    ...
    #
    # @return [NylasV2::Threads] Thread resources for your Nylas application.
    def threads
      Threads.new(self)
    end
    ...
    #
    # @return [NylasV2::Webhooks] Webhook resources for your Nylas application.
    def webhooks
      Webhooks.new(self)
    end
  end
