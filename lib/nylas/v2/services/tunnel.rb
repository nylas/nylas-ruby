...
module Nylas::V2
  ...
  class Tunnel
    ...
    def self.open_webhook_tunnel(api, config = {})
      ...
      triggers = config[:triggers] || Nylas::V2::WebhookTrigger.constants(false).map { |c| Nylas::V2::WebhookTrigger.const_get c }
    ...
    # @param triggers [Array<Nylas::V2::WebhookTrigger>] The list of triggers to subscribe to
